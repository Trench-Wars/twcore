        ...
        m_scanForCapitalShips = new TimerTask(){
            public void run(){
                if( !m_botAction.freqContainsShip( 0, 4 )){
                    m_botAction.sendArenaMessage( "Freq 0 is without a capital ship!  The first person to message SCBot with !capital will be the new capital ship." );
                }
                if( !m_botAction.freqContainsShip( 1, 4 )){
                    m_botAction.sendArenaMessage( "Freq 1 is without a capital ship!  The first person to message SCBot with !capital will be the new capital ship." );
                }
            }
        };
