...
public class LvzObject implements Cloneable
{
    ...
    */
    ...
    {
        if(objUpdateInfo == null || objUpdateInfo.length != 11) {
    ...
    */
    public boolean          updateLocation()    {
        return (this.objUpdateInfo[0] & 0x01) != 0;
    }
    ...
    */
    public boolean          updateImage()       {
        return (this.objUpdateInfo[0] & 0x02) != 0;
    }
    ...
    */
    public boolean          updateLayer()       {
        return (this.objUpdateInfo[0] & 0x04) != 0;
    }
    ...
    */
    public boolean          updateDisplayTime() {
        return (this.objUpdateInfo[0] & 0x08) != 0;
    }
    ...
    */
    public boolean          updateDisplayMode() {
        return (this.objUpdateInfo[0] & 0x10) != 0;
    }
    ...
    */
    public boolean          isMapObject()       {
        return (this.objUpdateInfo[1] & 0x01) != 0;
    }
    ...
    */
    public int              getObjectID()       {
        return ((this.objUpdateInfo[1] & UINT8_MASK) | ((this.objUpdateInfo[2] & UINT8_MASK) << 8)) >>> 1;
    }
    ...
    */
    public int              getXLocation()      {
        return ((this.objUpdateInfo[3] & UINT8_MASK) | ((this.objUpdateInfo[4] & UINT8_MASK) << 8)) >>> (this.isMapObject() ? 0 : 4);
    }
    ...
    */
    public int              getYLocation()      {
        return ((this.objUpdateInfo[5] & UINT8_MASK) | ((this.objUpdateInfo[6] & UINT8_MASK) << 8)) >>> (this.isMapObject() ? 0 : 4);
    }
    ...
    /**
        ...
        @return See above.
    */
    public byte             getXLocationType()  {
        return (byte) (this.isMapObject() ? this.objUpdateInfo[3] & 0x0F : 0);
    }
    ...
    /**
        ...
        @return See above.
    */
    public byte             getYLocationType()  {
        return (byte) (this.isMapObject() ? this.objUpdateInfo[5] & 0x0F : 0);
    }
    ...
    */
    public int             getImageID()         {
        return (this.objUpdateInfo[7] & UINT8_MASK );
    }
    ...
    */
    public int              getLayer()          {
        return (this.objUpdateInfo[8] & UINT8_MASK);
    }
    ...
    */
    public int              getDisplayTime()    {
        return ((this.objUpdateInfo[9] & UINT8_MASK) | ((this.objUpdateInfo[10] & UINT8_MASK) << 8)) & 0x0FFF;
    }
    ...
    */
    public byte             getDisplayMode()    {
        return (byte) ((this.objUpdateInfo[10] & UINT8_MASK) >>> 4);
    }
    ...
    */
    ...
    {
        if(boolUpdate) {
            this.objUpdateInfo[0] |= 0x01;
        }
        else {
            this.objUpdateInfo[0] &= 0xFE;
        }
    ...
    */
    ...
    {
        if(boolUpdate) {
            this.objUpdateInfo[0] |= 0x02;
        }
        else {
            this.objUpdateInfo[0] &= 0xFD;
        }
    ...
    */
    ...
    {
        if(boolUpdate) {
            this.objUpdateInfo[0] |= 0x04;
        }
        else {
            this.objUpdateInfo[0] &= 0xFB;
        }
    ...
    */
    ...
    {
        if(boolUpdate) {
            this.objUpdateInfo[0] |= 0x08;
        }
        else {
            this.objUpdateInfo[0] &= 0xF7;
        }
    ...
    */
    ...
    {
        if(boolUpdate) {
            this.objUpdateInfo[0] |= 0x10;
        }
        else {
            this.objUpdateInfo[0] &= 0xEF;
        }
    ...
    */
    ...
    {
        if((this.objUpdateInfo[1] & 0x01) == 0) {
            intLocation = (intLocation << 4) | (this.objUpdateInfo[3] & 0x0F);
        }
    ...
    */
    ...
    {
        if((this.objUpdateInfo[1] & 0x01) == 0) {
            intLocation = (intLocation << 4) | (this.objUpdateInfo[5] & 0x0F);
        }
    ...
    */
    ...
    {
        if((this.objUpdateInfo[1] & 0x01) == 0) {
            this.objUpdateInfo[3] = (byte) ((this.objUpdateInfo[3] & 0xF0) | (bType & 0x0F));
        }
    ...
    */
    ...
    {
        if((this.objUpdateInfo[1] & 0x01) == 0) {
            this.objUpdateInfo[5] = (byte) ((this.objUpdateInfo[5] & 0xF0) | (bType & 0x0F));
        }
