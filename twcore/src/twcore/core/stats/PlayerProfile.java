...
public class PlayerProfile 
{
	...
	public void hit( String defender, int damage ) {
		if( peeps.containsKey( defender ) )
    		((Enemy)peeps.get( defender )).addDamageDealt( damage );
    	else 
