...
public class GamePacketGenerator {
    ...
    public void sendSpectatePacket( short playerID ) {
        ...
        // Changed to immediate so that spectate packet is not sent reliably.
        // sendImmediateSpectatePacket is still "more" immediate.
        composeImmediatePacket( bytearray, 3 );
    }
