...
public class LagHandler {
    ...
    public LagHandler(BotAction botAction, BotSettings botSettings, Object b, String method) {
        ba = botAction;
    ...
    public void adjustTinfoValues() {
        ...
        for (int index = 1; index < tinfoValues.size(); index++) {
            ...
            //          ba.sendPrivateMessage("Sika", tinfoValue.intValue() + " -> " + newValue);
    ...
    public void startLagRequest(String pName, String req) {
        ...
        if (ba.getFuzzyPlayerName(playerName) == null) {
            spamLagInfo(false, false);
        } else {
            playerName = ba.getFuzzyPlayerName(playerName);
