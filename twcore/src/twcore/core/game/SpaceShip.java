...
public class SpaceShip extends Thread
{
    ...
    public void setDir(int tD) {
        d = tD;
    }

    public void setMaxSpeed(int tMSpeed) {
        SPEED = tMSpeed;
    }

    public void setMaxRotation(int tMRotation) {
        ROTATION = tMRotation;
    }

    public void setMaxThrust(int tMThrust) {
        THRUST = tMThrust;
    }
