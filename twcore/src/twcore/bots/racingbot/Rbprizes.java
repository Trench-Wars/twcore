...
public class Rbprizes extends RBExtender
{
  ...
  public void handleEvent(Message event)
  {
    if(event.getMessageType() == Message.PRIVATE_MESSAGE)
    {
      ...
      if(m_opList.isER(playerName) || m_rbBot.twrcOps.contains(playerName.toLowerCase()))
        handleCommand(playerName, event.getMessage().toLowerCase());
      if(m_opList.isSmod(playerName) || m_rbBot.twrcOps.contains(playerName.toLowerCase()))
  ...
  public int getPrizeNumber(String prizeString)
  {
  ...
  public void doPrizeAll(String sender, String argString)
  {
    ...
    try
    {
      ...
      {
        case 1:
          prizeNumber = getPrizeNumber(argTokens.nextToken());
