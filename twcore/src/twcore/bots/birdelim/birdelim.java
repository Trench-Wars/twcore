...
/**
    Bot for hosting ?go birdelim
    @author  flibb
*/
public final class birdelim extends SubspaceBot implements LagoutMan.ExpiredLagoutHandler<String> {
    ...
    */
    ...
    private void removePlayerAndCheck(KimPlayer kp, String reason) {
        ...
        if(m_state.isMidGame() && m_groupCount[group] == 1) {
            ...
            if(m_groupCount[0] + m_groupCount[1] + m_groupCount[2] + m_groupCount[3] == 1) {
                m_botAction.scheduleTask(new EndGameTask(), 4000);
            }
        }
    }
    ...
    private void putPlayerInGame(int id, KimPlayer kp, boolean disableWarping) {
        ...
        m_botAction.setShip(id, Tools.Ship.WARBIRD);
    ...
    public void handleEvent(Message event) {
        ...
        if(msg.equals("!help")) {
            ...
            m_botAction.sendPrivateMessage(id, "KimBot! (2015-01-09) by flibb <ER>", 7);
    ...
    */
    private void setBaseSpawns() {
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-X:141");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-Y:329");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-Radius:92");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-X:343");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-Y:329");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-Radius:92");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-X:683");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-Y:329");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-Radius:92");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-X:885");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-Y:329");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-Radius:92");

    }

    private void setFinalSpawns() {
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-X:514");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-Y:418");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team0-Radius:60");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-X:514");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-Y:418");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team1-Radius:60");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-X:514");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-Y:418");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team2-Radius:60");

        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-X:514");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-Y:418");
        m_botAction.sendUnfilteredPublicMessage("?set Spawn:Team3-Radius:60");
    }
    ...
    */
    ...
    private final class State {
        ...
        synchronized boolean isPreGame() {
            return m_state == PREGAME;
        }
        ...
        synchronized boolean isMidGame() {
            return m_state == MIDGAME;
        }

        synchronized boolean isStartingFinal() {
            return m_state == STARTING_FINAL;
        }

        synchronized boolean isMidGameFinal() {
            return m_state == MIDGAME_FINAL;
        }

        synchronized boolean isEndingGame() {
            return m_state == ENDING_GAME;
        }
    ...
    = {
        ...
        {   "_        ___ ___ __ ___  ___ _    ___ __  __",
            "_       | _ )_ _| _ |   || __| |  |_ _|  |/  |",
            "_       | _ || ||   | |) | _|| |__ | || |//| |",
            "_       |___/___|_|_|___/|___|____|___|_|  |_|"
        },
        ...
        {   "_          ___  _______  ___  ______   ______  ___",
            "_         / _ )/  _/ _ )/ _ )/ __/ /  /  _/  |/  /",
            "_        / _  |/ // , _/ // / _// /___/ // /|_/ /",
            "_       /____/___/_/|_/____/___/____/___/_/  /_/"
        }
    };
}
