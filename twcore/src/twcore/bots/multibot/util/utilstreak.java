    ...
    public void handleCommand( String name, String message ) {
        if( message.toLowerCase().startsWith( "!streakoff" ) ) {
            ...
            try {
                ...
                m_botAction.sendPrivateMessage( name, "Could not start streak watching.  Syntax: !streak <start> <update>" );
            }
            ...
            try {
                ...
                m_botAction.sendPrivateMessage( name, "Could not start death streak watching.  Syntax: !negstreak <start> <update>" );
            }
        }
    }
