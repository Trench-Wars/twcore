...
public class dodgeball extends MultiModule {
    ...
    */
    ...
    private class Ball {
        ...
        public short getPreviousCarrier() {
            return previousCarrier;
        }
        public long  getPreviousCarrierTime() {
            return previousCarrierTime;
        }

        public void setCarrier(short carrier) {
            this.carrier = carrier;
        }
        public void setPreviousCarrier(short previousCarrier) {
            this.previousCarrier = previousCarrier;
        }
        public void setPreviousCarrierTime(long previousCarrierTime) {
            this.previousCarrierTime = previousCarrierTime;
        }
