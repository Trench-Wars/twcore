...
public class xdodgeball extends MultiModule {
    ...
    private void doSpamRules() {
    	m_botAction.sendArenaMessage("-----------------------------DESE ARE RULES PLZ READ OK----------------------------");
    ...
    private void startGame() {
    	...
    	if (!turbo) {
    		...
    		m_botAction.sendArenaMessage("Round is about to begin!", 2);
    	}
    ...
    private void startFreq0Timer() {
		...
		m_botAction.scheduleTask(freq0Timer, doorTimer);
    }
    ...
    private void startFreq1Timer() {
		...
		m_botAction.scheduleTask(freq1Timer, doorTimer);
    }
