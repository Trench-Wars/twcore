...
//    }
    ...
    public void addPlayer(String name, int shipType) {
        ...
        final int playerShip = shipType;
            ...
            m_players.put(name, new twhtPLAYER(name.toLowerCase(), m_fcTeamName, shipType, this));
    ...
    public void setFreqAndSide() {
        ...
        for (twhtPLAYER i : m_players.values()) {
           if (i != null){
                ...
                if (m_fnFrequency == 0)
                ba.warpTo(i.getPlayerName(), 415, 512);
                else if (m_fnFrequency == 1)
                ba.warpTo(i.getPlayerName(), 600, 512);
                }
            }
        }
    }
    ...
    public void removePenalty(String name) {
        twhtPLAYER p;
        
        p = m_players.get(name);
        p.changePlayerState(1);
        p.resetPenalty();
    }
