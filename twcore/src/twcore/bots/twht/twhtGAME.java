...
public class twhtGAME {
    ...
    /**
     * This method checks if a lagout request is legal and if so, it will send the 
    ...
    public void reqLagoutPlayer(String name, String msg) {
        ...
        if (m_team1.isPlayer(name)){
            ...
            ba.sendPrivateMessage(name, "You are not on either team.");
            return;
        }
        
        if (team.isLaggedOut(name)) {
            refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 6, name, team.getTeamName(), name));
        } else {
    ...
    /**
     * This method checks if a add player request is legal and if so, it will send the 
     * request to the referee.
     * 
     * @param name
     * @param msg
    ...
    //            }
                ...
                refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 0, name, teamName,playerName + ":" + shipNum));
    ...
    /**
     * This method checks if a remove is legal and if so, it will send the 
     * request to the referee.
     * 
     * @param name
     * @param msg
    ...
    public void reqRemovePlayer(String name, String msg) {
        ...
        playerA = team.searchPlayer(msg);           
            ...
            if (playerA != null) {
                refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 4, name, team.getTeamName(), playerA.getPlayerName()));
    ...
    /**
     * This method checks if a switch is legal and if so, it will send the 
     * request to the referee.
     * 
     * @param name
     * @param msg
            ...
            if (splitCmd.length == 2) {
                ...
                if (playerA != null && playerB != null){
                    if ((playerA.getPlayerState() == 1 || playerA.getPlayerState() == 4) && (playerB.getPlayerState()  == 1 || playerB.getPlayerState() == 4)) {
                        refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 2, name, team.getTeamName(), playerA.getPlayerName() + ":" + playerB.getPlayerName()));
    ...
    /**
     * This method checks if a substitution is legal and if so, it will send the 
     * request to the referee.
     * 
     * @param name
     * @param msg
    ...
    //                        }
                            ...
                            if (shipNum <= 8 && shipNum >= 1 ) {
                                refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 1, name, team.getTeamName(), playerA.getPlayerName() + ":" + playerBName + ":" + shipNum));
    ...
    /**
     * This method checks if a ship change is legal and if so, it will send the 
     * request to the referee.
     * 
     * @param name
     * @param msg
    ...
    public void removePenalty(String name, String msg) {
        ...
        if (team != null) {
            ...
            team.removePenalty(playerA.getPlayerName());
    ...
    public void cmd_timeOut(String name, String msg) {
        ...
        if (m_team1.isCaptain(name)){
            teamName = m_fcTeam1Name;
            refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 5, name, teamName, name));
        } else if (m_team2.isCaptain(name)) {
            teamName = m_fcTeam2Name;
            refRequest.put(getNextRecordNumber(), new RefRequest(getNextRecordNumber(), m_curRound.m_roundNum, 5, name, teamName, name));
        } else {
    ...
    /**
     * This method checks if player is on a team and then returns the frequency
     * that the team is currently
     * @param name
     * @return
     */
    ...
    public void getStatus(String name, String msg) {
        if (m_curRound != null) {
            ba.sendPrivateMessage(name, "Currently in round " + m_curRound.m_roundNum + " with " + m_fcTeam1Name + "(" + fnTeam1Score + ") vs " + m_fcTeam2Name + "(" + fnTeam2Score + ")");
        }
    }   
    ...
    public void doReady(String name) {
        if (m_curRound != null && (m_curRound.m_fnRoundState == 0 || m_curRound.m_fnRoundState == 2)) {
        twhtTEAM team;
