...
public class utilshiprestrict extends MultiUtil {
    ...
    */
    ...
    public void doRestricts(String sender, String argString)    {
        if (universal)
        {
            m_botAction.sendSmartPrivateMessage(sender, "Universal settings in effect, clear then then try again");
            return;
        }
    ...
    */
    ...
    public void doListExempt(String sender) {
        if (Exmpt.isEmpty())
        {
            m_botAction.sendPrivateMessage(sender, "Nobody is Exempt!");
            return;
        }
    ...
    */
    ...
    public void doClear(String sender, String argString)    {
        if (universal)
        {
            m_botAction.sendPrivateMessage(sender, "Universal restrictions in effect, there are no freq-specific restrictions.");
            return;
        }
        ...
        try {
            ...
            {
                m_botAction.sendSmartPrivateMessage(sender, "Requested freq is not restricted");
                return;
            }
