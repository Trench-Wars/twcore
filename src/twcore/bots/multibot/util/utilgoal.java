...
public class utilgoal extends MultiUtil {
    ...
    */
    ...
    public void handleEvent(SoccerGoal event) {
        ...
        if (goalmessage != null) {
            if (goalsound != 0)
                m_botAction.sendPrivateMessage(goalscorer, goalmessage, goalsound);
            else
    ...
    */
    ...
    public void doGoalMessage(String sender, String argString) {
        if (argString.equals("~*")) {
            ...
            m_botAction.sendPrivateMessage(sender, "Goal message is now : \"" + goalmessage + (goalsound != 0 ? "\" %" + goalsound : "\""));
        }
    }
    ...
    */
    ...
    public void doGoalPrize(String sender, String argString) {
        if (argString.equals("~*")) {
            ...
            m_botAction.sendPrivateMessage(sender, "Goal prize is now \"" + goalprize + "\"");
        }
    }
