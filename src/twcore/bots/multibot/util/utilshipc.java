    ...
    */
    ...
    public void handleEvent( FrequencyShipChange event )    {
        if(validstart)  {
            ...
            if(plyrP == null) {
                m_botAction.specWithoutLock(plyrName);    //if the most manually adds, spec, for they arn't on the hash
                AddSpec(plyrName);
                return;
            }
